...
plt.tight_layout()
plt.savefig('outputs/pre_correlation_heatmap.png', dpi=150)
plt.close()

# Top 3 correlated pairs (off-diagonal, lower triangle)
...
# ─────────────────────────────────────────────
# Export processed data for other parts
# ─────────────────────────────────────────────
import joblib, os
...
print("\nPreprocessing complete. Data saved to models/preprocessed_data.pkl")
print("Heatmap saved to outputs/pre_correlation_heatmap.png")
